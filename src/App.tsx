...
import { TenancyDashboard } from "./components/tenancy/TenancyDashboard";
...
export default function App() {
  ...
  if (window.location.pathname === "/dev/billing") {
    return (
      <AuthProvider>
        <DeveloperBilling />
      </AuthProvider>
  ...
  if (window.location.pathname === "/dev/exercise-library") {
    return (
      <AuthProvider>
        <DeveloperExerciseLibrary />
      </AuthProvider>
    );
  }
